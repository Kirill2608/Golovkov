...
describe('work', () => {
   ...
   // 2. Можете использовать этот сайт для практик
   // 3. Задание с * у кого есть желание дополнительно (https://demoqa.com/nestedframes) Напишите тест на переключение между фреймами
